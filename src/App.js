...
const App = () => {
  ...
  // ── Season goal state ──
  const [seasonGoal, setSeasonGoal] = useState(""); // e.g. "Pass all exams by Sept 26"
  const [seasonDeadline, setSeasonDeadline] = useState(""); // deadline date
  const [weeklyFocus, setWeeklyFocus] = useState(["", "", ""]); // array of 3 focus areas
            ...
            >
              ...
              {seasonGoal ? (
                <div>
                  ...
                  >
                    {seasonDeadline && `Deadline: ${seasonDeadline}`}
                  </div>
                </div>
              ) : (
                <div
                ...
                >
                  Tap to set a season goal (e.g., "Pass all exams by Sept 26")
                </div>
              )}
            </div>
              ...
              >
                <div style={{ marginBottom: "12px" }}>
                  ...
                  <input
                    ...
                    placeholder="e.g. Pass all exams by Sept 26"
                    style={{
                      width: "100%",
                      padding: "10px 12px",
                      background: th.bg,
                      border: `1px solid ${th.textMuted}33`,
                      borderRadius: "8px",
                      color: th.text,
                      fontSize: "0.9rem",
                      fontFamily: "inherit",
                ...
                >
                  {weeklyFocus.map((focus, i) => (
                    <input
                      ...
                      placeholder={`Focus area ${i + 1} (optional)`}
                      style={{
                        width: "100%",
                        padding: "10px 12px",
                        background: th.bg,
